"""
Django settings for SPstunting project.
...
SECRET_KEY = 'django-insecure-u^u#a74h=6vv(5$x93zawyseixl%8dz0ek*r$^hy__dg66&o#8'
...
INSTALLED_APPS = [
    'jazzmin',  # Django Jazzmin - must be at the top
...
WSGI_APPLICATION = 'SPstunting.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "SP Stunting",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "SP Stunting",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "SP Stunting",
    ...
    "welcome_sign": "Selamat Datang di Panel Pakar SP Stunting",

    # Copyright on the footer
    "copyright": "SP Stunting",

    # List of model admins to search from the search bar, search bar omitted if excluded
    # If you want to use a single search field you dont need to use a list, you can use a simple string 
    "search_model": ["auth.User", "core.Pasien"],
...
# For production deployment, uncomment and configure these settings:
